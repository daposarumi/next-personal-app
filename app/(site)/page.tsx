...
export default async function Home() {
  ...
  return (
    <div>
      ...
      <p className="mt-4 text-xl text-gray-600 max-w-2xl">I&apos;m a frontend engineer and I&apos;m passionate about creating user-centred systems. These are my most recent front-end projects. Check them out and let me know what you think. Also, i look forward to working with you!</p>
