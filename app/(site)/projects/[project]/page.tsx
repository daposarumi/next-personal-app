...
export default async function Project({ params }: Props) {
    ...
    <div>
        <header className="flex items-center justify-between">
            <h1 className="bg-gradient-to-r from-orange-400 via-red-500 to-purple-600 bg-clip-text text-transparent lg:text-5xl sm:text-3xl drop-shadow font-extrabold">{project.name}</h1>
